      ...
      >
        <tbody>
          ...
          <tr>
            ...
            <td className="p-2 border border-gray-300 bg-white">100.0</td>
          </tr>
          <tr>
            <td className="font-bold p-2 bg-rose-200 w-[30%] border border-gray-300">% Reprobados</td>
            <td className="p-2 border border-gray-300 bg-white">0.0</td>
          </tr>
          <tr>
      ...
      >
        ...
        <tbody>
          {mockSemestres.map((fila, idx) => (
            <tr key={idx}>
              <td className="p-2 text-center border">{fila.anio}</td>
              <td className="p-2 text-center border">{fila.sem}</td>
              <td className="p-2 text-center border">{fila.nSem}</td>
              <td className="p-2 text-center border">{fila.aprob}</td>
              <td className="p-2 text-center border">{fila.reprob}</td>
              <td className="p-2 text-center border">{fila.elim}</td>
              <td className="p-2 text-center border">{fila.total}</td>
